...
import {Channel, ChannelHeader, Chat, MessageList, MessageInput, Thread, Window} from 'stream-chat-react';
...
const ChatPage = () => {
  ...
  const handleVideoCall = () => {
    if(channel){
      ...
      toast.success("Video call link sent successfully in chat!")
    }
  }
