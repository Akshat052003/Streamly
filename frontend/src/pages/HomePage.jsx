          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">Discover perfect connections based on your profile</p>
              </div>
            </div>
          </div>
                ...
                return(
                  <div key={user._id} className="card bg-base-200 hover:shadow-lg transition-all duration-300">
                    <div className="card-body p-5 space-y-4">
                      ...
                      <button onClick={() => sendRequestMutation(user._id)} disabled = {hasRequestBeenSent || isPending} className={`btn w-full rounded-full mt-2 ${hasRequestBeenSent ? "btn-disabled" : "btn-primary"}`}>
                        {hasRequestBeenSent ? (<>
